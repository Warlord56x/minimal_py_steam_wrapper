...
def update_dict():
    jupdater = open("games.json", "r")
    gamesdict = json.load(jupdater)
    return gamesdict
...
def get_game(appid):
    """Returns the game with the given 'appid', if it is a game, otherwise returns 'None'"""
